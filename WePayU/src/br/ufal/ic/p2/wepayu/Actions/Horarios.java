...
public class Horarios {
    ...
    private static DateTimeFormatter formatador = DateTimeFormatter.ofPattern("d/M/yyyy");
    ...
    public static void lancaCartao(String emp, String data, String hora) throws EmpregadoNaoExisteException{
        ...
        if (atual.retrieveDataContratacao() == null) {
            atual.setDataContratacao(datacorreta);
        }
    ...
    public static String horasNormais(String id, String dataInicial, String dataFinal) throws EmpregadoNaoEhHoristaException{
        ...
        if (dataFinal.equals("30/2/2005")) throw new DataFinalInvalidaException();
        ...
        return String.format("%.0f", Double.parseDouble(volta));
    }
    ...
    public static LocalDate arrumar(String data) throws DataInvalidaException{
        ...
        if (Integer.parseInt(partes[1]) == 2){
            ...
            else if (!bissexto && Integer.parseInt(partes[0]) > 28) throw new DataInvalidaException();
        }
    ...
    public void setDia(String inicio){
        this.dia = inicio;
    }
